...
format["Event Monitor:: Amount of events since server start -- HELICRASH [%1] -- SUPPLYDROP [%2] -- CONVOY [%3] -- AIRPATROL [%4]",Event_HeliCrash_monitorCount,Event_SupplyDrop_monitorCount] call ExileServer_util_log;
