...
VERSION_DATE_IS = '16-Feb-2017 00-50-33';
...
fnc_initOnKeyPress = {
	...
	_ctrl ctrlSetText format['Players loaded in: %1 of %2                 SERVER UPTIME: %3  SERVER FPS: %4  SERVER THREADS: %5          infiSTAR.de Admin Menu 16-Feb-2017 00-50-33 - v0072',count allPlayers,((playersNumber west)+(playersNumber east)+(playersNumber civilian)+(playersNumber resistance)),time call GET_TIME_TIME,SERVER_FPS,SERVER_THREADS];
