...
UPDATEEMAIL='donations@nzelitecampers.com';
INFISTARVERSION='16-Feb-2017 00-50-33 - v0072';
...
diag_log format['<infiSTAR.de> %1 - VERSION: 16-Feb-2017 00-50-33 - v0072',time];
{
	_x params ['_uids'];
	{
		private _uid = _x;
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!   [donations@nzelitecampers.com - 16-Feb-2017 00-50-33 - v0072 - %2 - %3]',_t,serverName,productVersion];
...
{
	diag_log format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp is not in your MPMission or you forgot to #include it within your description.ext   [donations@nzelitecampers.com - 16-Feb-2017 00-50-33 - v0072 - %2 - %3]',_t,serverName,productVersion];
};
_test = [0,{}] execFSM 'call.fsm';
_test = [0,{}] execFSM 'call.fsm';
if(_test isEqualTo 0)exitWith
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!   [donations@nzelitecampers.com - 16-Feb-2017 00-50-33 - v0072 - %2 - %3]',_t,serverName,productVersion];
...
FNC_A3_CUSTOMLOG = "
	...
	diag_log format['<infiSTAR.de>%1| %2   [16-Feb-2017 00-50-33 - v0072]',_logname,_logentry];
";
...
_s_m = toArray "donations@nzelitecampers.com";
_s_u = toArray "76561198006986532";
_s_v = toArray "16-Feb-2017 00-50-33 - v0072";
...
_fnc_RandomGen =
{
	...
	_fnc_actualGen = {
		...
		_main	= ['t','Q','a','Q','S','S','o','i','Y','y','1','x','B','6','0','O','k','x','P','6','W','l','h','h','h','M','G','X','B','H'];
...
['RANDOMVAR','----START-LINE----   (16-Feb-2017 00-50-33 - v0072 - donations@nzelitecampers.com)'] call FNC_A3_CUSTOMLOG;
...
['RANDOMVAR','----END-LINE----   16-Feb-2017 00-50-33 - v0072'] call FNC_A3_CUSTOMLOG;
...
_devLog = format['infiSTAR.de AHAT %1 - 16-Feb-2017 00-50-33 - v0072 - server running: %2:583',VERSIONCHECKRESULT,time call GET_TIME_TIME];diag_log _devLog;
"; if(!_HIDE_FROM_PLAYERS)then{ _asd = _asd + "
...
_from = 'donations@nzelitecampers.com';
_vers = '16-Feb-2017 00-50-33 - v0072';
...
['SERVER_INFO',format['[SERVER START] TIME: %1 || EMAIL: donations@nzelitecampers.com || VERSION: 16-Feb-2017 00-50-33 - v0072 || Local Server Time: %2',time,serverStartTime]] call FNC_A3_RL;
