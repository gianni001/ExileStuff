...
*/
serverCommandPassword = "gianni001";
...
{
	{
		{"76561197972232595","76561197993112948"},	/* Admins with UIDs in this Array have their Access defined in the array below. */
		{
...
ESCMNUTOP = "Aftermath Survival";
ESCMNUBOT = "by JohnO & Bek";
...
blacklistedVariables[] =
{
	...
	"SNI_PRZ_ZZZ_TargetPlayer","healit","O_fnc_ArmA","MLRN_EXEC","running_threads","catchemall600","killtarget","GMToggle","t1","FUCK_ME_keyp","CheatCurator"
};
