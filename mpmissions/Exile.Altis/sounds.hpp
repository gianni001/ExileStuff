class CfgSounds
{
    sounds[] = {code1,code2,code3,cough1,cough2,cough3,cough4,cough5,cough6,heart1,heart2,heart3,heart4,heart5,bl_begin,bl_hit1,bl_hit2,bl_hit3,bl_wave1,bl_wave2,bl_wave3,bl_psi,bl_full,bl_detect,apsi_on,apsi_off,ns_fx_misc4,ns_fx_drone1,ns_fx_drone2,hit1,hit2,hit3,hit4,hit5,hit6,hit7,hit8,hit9,legbreak,shivering};
    ...
    {
        name = "Shivering";
        sound[] = {"sounds\shivering.ogg",1.0,1.0};
        titles[] = {};
    };
};